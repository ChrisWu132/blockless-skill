...
5. Iterate the defective aspect and re-render. Save screenshots using “Save view”. User-driven changes are not capped; unsuccessful automatic corrections to one defect are bounded by the main Skill.
